...
const TABS: {
  ...
  to: "/learn/inventor/part" | "/learn/inventor/learn" | "/learn/inventor/articles";
  closable?: boolean;
}[] = [
  { id: "part", label: "Part1", icon: Box, to: "/learn/inventor/part", closable: true },
  { id: "tutorials", label: "Tutorials", icon: GraduationCap, to: "/learn/inventor/learn", closable: true },
  { id: "articles", label: "Articles", icon: BookOpen, to: "/learn/inventor/articles", closable: true },
];
      ...
      {TABS.map((t) => {
        ...
        return (
          <Link
            ...
            activeProps={{
              className: cn(
                "flex items-center gap-1.5 px-2.5 text-xs border-l border-r border-inventor-ribbon-border -ml-px",
